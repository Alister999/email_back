"""
Django settings for email_back project.
...
SECRET_KEY = 'django-insecure-gvafx(fh0joc@)e=44j+q_-+f%p%^!%1$uy0akp_n0ja1-m4#%'
...
ADMINS = [
    ("Admin", os.getenv("SEND_EMAIL")), #"dr.borgaw@icloud.com"),
]
